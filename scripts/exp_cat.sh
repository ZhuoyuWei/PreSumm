...
PRETRAINED_PATH=/data/zhuoyu/summarization/models/bertbase_cat
...
-log_file $BERT_OUTPUT_PATH/logs/ext_bert_cnndm -use_interval true -warmup_steps 10000 -max_pos 512 -dist_init_method "tcp://localhost:10001" \
