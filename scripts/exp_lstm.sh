...
-lr 2e-3 -visible_gpus 0,1,2,3,4,5,6,7 -report_every 50 -save_checkpoint_steps 2000 -batch_size 1000 -train_steps 50000 -accum_count 2 \
...
-model_name bert_lstm -pretrained_name $PRETRAINED_PATH -max_model_pos=128 -gobal_layer_type=lstm
...
-test_all true -model_name bert_lstm -pretrained_name $PRETRAINED_PATH -max_model_pos=128 -gobal_layer_type=lstm -report_rouge=False