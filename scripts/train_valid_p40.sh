...
-lr 2e-3 -visible_gpus 0,1,2,3 -report_every 50 -save_checkpoint_steps 1000 -batch_size 3000 -train_steps 50000 -accum_count 2 \
...
cd code/PreSumm/src
python train.py -task ext -mode validate -batch_size 3000 -test_batch_size 3000 \
