...
BERT_OUTPUT_PATH=/data/zhuoyu/summarization/workspace/run_training_2

mkdir $BERT_OUTPUT_PATH
mkdir $BERT_OUTPUT_PATH/logs

CUDA_VISIBLE_DEVICES=3,4,5 python train.py -task ext -mode train -bert_data_path $BERT_DATA_PATH \
