...
-lr 2e-3 -visible_gpus 0 -report_every 50 -save_checkpoint_steps 1000 -batch_size 2000 -train_steps 50000 -accum_count 2 \
...
-model_name $ZONG_MODEL -pretrained_name $MODEL_DIR -max_model_pos=$MAX_MODEL_POS -encoder=$ENCODER_TYPE -max_tgt_len=$MAX_MODEL_POS
cd ../../..
